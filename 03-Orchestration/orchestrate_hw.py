...
@flow
def main_flow_1(
    train_path: str = "/Users/mac/Demo/03-Orchestration/data/green_tripdata_2023-02.parquet",
    val_path: str = "/Users/mac/Demo/03-Orchestration/data/green_tripdata_2023-03.parquet",
) -> None:
